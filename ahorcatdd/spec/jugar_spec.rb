...
describe Jugar do
	...
	it "Cuando no se ingresa ninguna letra debe devolver N" do
		@jugar.iniciar_secuencia("HOLA")
		expect(@jugar.ganaste_juego).to eq("N")		
	end

		it "Al completar todas las letras debe indicar que ganaste" do
		@jugar.iniciar_secuencia("HOLA")
		@jugar.adivinar("O")
		@jugar.adivinar("H")
		@jugar.adivinar("L")
		@jugar.adivinar("A")
		expect(@jugar.ganaste_juego).to eq("S")		
	end
end
